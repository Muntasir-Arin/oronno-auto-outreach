          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
                  <AreaChart data={sentimentData}>
                    ...
                    <YAxis stroke="#6b7280" domain={[0, 1]} fontSize={12} />
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Calls distribution throughout the day</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={callVolumeData}>
                    ...
                    <Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb" }} />
                    <Bar dataKey="calls" fill="url(#colorCalls)" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={funnelData} layout="vertical">
                    ...
                    <YAxis dataKey="stage" type="category" stroke="#6b7280" width={100} fontSize={12} />
                    <Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb" }} />
